...
//	client2 "github.com/hstreamdb/hstreamdb-go/internal/client"
...
//
//	res := make([]client2.AppendResult, 0, 10)
//	for i := 0; i < 10; i++ {
//		r := producer.Append(client2.RAWRECORD, []byte("test-value"+strconv.Itoa(i)))
//		res = append(res, r)
//	}
//
