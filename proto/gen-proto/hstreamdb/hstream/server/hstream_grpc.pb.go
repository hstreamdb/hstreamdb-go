...
func (c *hStreamApiClient) DeleteStream(ctx context.Context, in *DeleteStreamRequest, opts ...grpc.CallOption) (*empty.Empty, error) {
	out := new(empty.Empty)
...
func (c *hStreamApiClient) DeleteShardReader(ctx context.Context, in *DeleteShardReaderRequest, opts ...grpc.CallOption) (*empty.Empty, error) {
	out := new(empty.Empty)
...
func (c *hStreamApiClient) DeleteSubscription(ctx context.Context, in *DeleteSubscriptionRequest, opts ...grpc.CallOption) (*empty.Empty, error) {
	out := new(empty.Empty)
...
func (c *hStreamApiClient) DescribeCluster(ctx context.Context, in *empty.Empty, opts ...grpc.CallOption) (*DescribeClusterResponse, error) {
...
func (c *hStreamApiClient) DeleteQuery(ctx context.Context, in *DeleteQueryRequest, opts ...grpc.CallOption) (*empty.Empty, error) {
	out := new(empty.Empty)
...
func (c *hStreamApiClient) PauseConnector(ctx context.Context, in *PauseConnectorRequest, opts ...grpc.CallOption) (*empty.Empty, error) {
	out := new(empty.Empty)
...
func (c *hStreamApiClient) ResumeConnector(ctx context.Context, in *ResumeConnectorRequest, opts ...grpc.CallOption) (*empty.Empty, error) {
	out := new(empty.Empty)
...
func (UnimplementedHStreamApiServer) DeleteStream(context.Context, *DeleteStreamRequest) (*empty.Empty, error) {
...
func (UnimplementedHStreamApiServer) DeleteShardReader(context.Context, *DeleteShardReaderRequest) (*empty.Empty, error) {
...
func (UnimplementedHStreamApiServer) DeleteSubscription(context.Context, *DeleteSubscriptionRequest) (*empty.Empty, error) {
...
func (UnimplementedHStreamApiServer) DescribeCluster(context.Context, *empty.Empty) (*DescribeClusterResponse, error) {
...
func (UnimplementedHStreamApiServer) PauseConnector(context.Context, *PauseConnectorRequest) (*empty.Empty, error) {
...
func _HStreamApi_DescribeCluster_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	...
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
		return srv.(HStreamApiServer).DescribeCluster(ctx, req.(*empty.Empty))
	}
	return interceptor(ctx, in, info, handler)
}
