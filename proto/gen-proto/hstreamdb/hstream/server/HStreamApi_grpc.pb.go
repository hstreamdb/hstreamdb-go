...
type HStreamApiClient interface {
	...
	// Create a stream with a select query, so the data generated by this select
	// query will be inserted to the stream automatically. Apart from this, the
	// stream are the same with any other streams, you can still use all the
	// stream rpc APIs above.
